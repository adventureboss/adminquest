...
const ExampleMenuItem = preload("res://Scenes/Dialogue/menu_item.tscn")
...
func _ready() -> void:
	...
	balloon.rect_global_position.y = balloon.get_viewport_rect().size.y - balloon.rect_size.y - 10
